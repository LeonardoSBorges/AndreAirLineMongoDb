...
using AndreAirLinesView.Data;
using AndreAirLinesView.Models;

namespace AndreAirLinesView.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AirportsController : ControllerBase
    {
        private readonly AndreAirLinesViewContext _context;

        public AirportsController(AndreAirLinesViewContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Airport>> PostAirport(Airport airport)
        {
            ...
            {
                if (AirportExists(airport.Abbreviation))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetAirport", new { id = airport.Abbreviation }, airport);
        }
        ...
        {
            return _context.Airport.Any(e => e.Abbreviation == id);
        }
    }
}
