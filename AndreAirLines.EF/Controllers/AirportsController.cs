...
namespace AndreAirLines.EF.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AirportsController : ControllerBase
    {
        private readonly AndreAirLinesEFContext _context;

        public AirportsController(AndreAirLinesEFContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Airport>> PostAirport(Airport airport)
        {
            ...
            return CreatedAtAction("GetAirport", new { id = airport.Iata }, airport);
        }
