...
namespace AndreAirLine.Dapper.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AirportsController : ControllerBase
    {
        private readonly AndreAirLineDapperContext _context;

        public AirportsController(AndreAirLineDapperContext context)
        {
            _context = context;
        }
